...
func SyncDatabase() {
	err:=DB.AutoMigrate(
		...
		&models.Otp{},&models.UserProfile{},&models.UserAddress{},&models.Cart{},&models.CartItem{},
		...
		&models.WalletGiftCard{},&models.Wishlist{},&models.WishlistItem{},&models.PaymentDetail{},
	)
	if err != nil{
